...
class TestTotalRibbon(unittest.TestCase):
    def test_case_1(self):
        self.assertEqual(executable_cpp_to_test("2x3x4"), 34)

    def test_case_2(self):
        self.assertEqual(executable_cpp_to_test("1x1x10"), 14)
    ...
    def test_large_input(self):
        large_input = """2x3x4
                        ...
                        4x4x4
                        6x7x8"""
        self.assertEqual(executable_cpp_to_test(large_input), 6707)

    def test_adv(self):
        # read input from input.txt
        adv_input = read_input_from_file("input.txt")
        self.assertEqual(executable_cpp_to_test(adv_input), 3842356)
