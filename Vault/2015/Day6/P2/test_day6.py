...
class TestLitLights(unittest.TestCase):
    ...
    def test_case_2(self):
        self.assertEqual(executable_cpp_to_test("toggle 0,0 through 0,0"), 2)
    ...
    def test_complex_case(self):
        ...
        self.assertEqual(executable_cpp_to_test(multi_input), 115771)
    ...
    def test_adv(self):
        ...
        self.assertEqual(executable_cpp_to_test(adv_input), 14110788)
